...
const CandidateCard = props => {
  return (
    <div className='bg-[#FFFEFC] border-2 border-maroon p-5 py-10 rounded-3xl text-center text-maroon flex flex-col items-center justify-center'>
        {/* IMAGE CONTAINER */}
        ...
        <div className='flex flex-col gap-5 lg:flex-row'>
            ...
            <button className='container px-6 py-1 border rounded-full border-maroon text-maroon bg-white2 hover:bg-maroon hover:text-white2'>
                View Details
            </button>
        </div>
    </div>
